...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RelationSelect = __webpack_require__(168);

	var _RelationSelect2 = _interopRequireDefault(_RelationSelect);
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      _axios2.default.get('/reactphp/index.php/Home/Index/initRelationData').then(function (response) {
	        _this2.setState({
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_RelationSelect2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RelationSelect = function (_Component) {
	  _inherits(RelationSelect, _Component);

	  function RelationSelect(props) {
	    _classCallCheck(this, RelationSelect);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(RelationSelect).call(this, props));
	  ...
	  _createClass(RelationSelect, [{
	    ...
	    key: 'getSubhierarchiesFromLevelAndIndices',
	    value: function getSubhierarchiesFromLevelAndIndices(hierarchies, indices) {
	      var tempHierarchies = hierarchies;
	    ...
	    value: function getActiveIndices(hierarchies) {
	    ...
	    key: 'renderSelect',
	    value: function renderSelect(items, activeIndex, level) {
	      var _this2 = this;

	      return _react2.default.createElement(
	        'div',
	        { key: level, className: 'col-sm-3' },
	        _react2.default.createElement(_Select2.default, { items: items, activeIndex: activeIndex, onChange: function onChange(e, item, index) {
	            var newActiveIndices = _this2.state.activeIndices.slice(0, level);
	            newActiveIndices.push(index);
	            var subHierarchies = _this2.getSubhierarchiesFromLevelAndIndices(_this2.props.hierarchies, newActiveIndices);
	            var nextActiveIndeices = _this2.getActiveIndices(subHierarchies);
	            newActiveIndices = [].concat(_toConsumableArray(newActiveIndices), _toConsumableArray(nextActiveIndeices));

	            _this2.setState({ activeIndices: newActiveIndices });
	          } })
	      );
	    }
	  }, {
	    ...
	    value: function renderSelects() {
	      var selects = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];

	      var indices = this.state.activeIndices;

	      for (var i = 0; i < indices.length; i++) {

	        var tempHierarchies = this.getSubhierarchiesFromLevelAndIndices(this.props.hierarchies, indices.slice(0, i));
	...
	exports.default = RelationSelect;
	...
	var Select = function (_Component) {
	  ...
	  _createClass(Select, [{
	    ...
	    value: function render() {
	      ...
	      var mvalue = this.state.items[this.state.activeIndex] ? this.state.items[this.state.activeIndex] : '';

	      return _react2.default.createElement(
	        'select',
	        { className: 'form-control', value: mvalue, onChange: function onChange(e) {
	            var val = e.target.value;
	            var index = _this2.state.items.findIndex(function (item) {
	              return item == val;
	            });
	            _this2.setState({ activeIndex: index });
	            if (_this2.props.onChange) {
	              _this2.props.onChange(e, val, index);
	            }
	          } },
	        this.renderItems()
	      );
